...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "user", "hello world @user", d2);
    ...
    public void testforSingleUser() {
        ...
        assertEquals("should have one user",1, mentionedUsers.size());
    }
    @Test
    public void testforMultiple() {
        Set<String> mentionedUsers = Extract.getMentionedUsers(Arrays.asList(tweet1,tweet2));
        
        assertEquals("should have two users",2, mentionedUsers.size());
        assertTrue("should contain user 'user'", mentionedUsers.contains("user"));
        assertTrue("should contain user 'alyssa'", mentionedUsers.contains("alyssa"));
    }
