...
public class FilterTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "user", "hello world", d2);
    ...
    public void testWrittenBysingleTweetsSingleResult() {
        List<Tweet> writtenBy = Filter.writtenBy(Arrays.asList(tweet3), "user");
    ...
    @Test
    public void testInTimespanSingleTweetsMultipleResults() {
        Instant testStart = Instant.parse("2016-02-17T09:00:00Z");
        Instant testEnd = Instant.parse("2016-02-17T12:00:00Z");
    ...
    public void testContains() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1), Arrays.asList("about"));
